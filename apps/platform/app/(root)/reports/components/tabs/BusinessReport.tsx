...
import { ReportBusinessUnitType, ReportClusterType, ReportSubType } from "@/dto/report.dto";
import { mockReportBusinessUnit } from "@/mock-data/reports";
import { Building2, FolderTree, MoreHorizontal } from 'lucide-react';
export default function BusinessReport() {
    const businessUnitReports = mockReportBusinessUnit;
