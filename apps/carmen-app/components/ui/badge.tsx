...
const badgeVariants = cva(
  "text-[10px] xl:text-[11px] inline-flex items-center rounded-full px-1.5 xl:px-2.5 py-0 xl:py-0.5 font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
