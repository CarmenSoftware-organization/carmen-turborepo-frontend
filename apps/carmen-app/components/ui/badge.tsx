...
const badgeVariants = cva(
  "text-xs md:text-base inline-flex items-center rounded-md border px-1.5 md:px-2.5 py-0 md:py-0.5 font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
