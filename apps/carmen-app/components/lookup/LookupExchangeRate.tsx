...
const LookupExchangeRate = forwardRef<HTMLButtonElement, ExchangeRateLookupProps>(
  (
    {
      value,
      onValueChange,
...
LookupExchangeRate.displayName = "LookupExchangeRate";

export default LookupExchangeRate;
