  ...
  return (
    <div>
      ...
      <div className="mt-2 space-y-2">
        <Textarea placeholder="Add a comment" value={comment} onChange={handleCommentChange} />
        ...
        {selectedFile ? (
          ...
          <div className="flex justify-between">
            <Button variant="outline" size="sm" onClick={handleUploadClick} className="gap-1">
              <Paperclip className="h-3 w-3" />
              Attach File
            </Button>
            <Button variant="default" size="sm" onClick={handleSend} disabled={!comment.trim()}>
        ...
        {selectedFile && (
          <div className="text-right">
            <Button variant="default" size="sm" onClick={handleSend} className="gap-1">
