  ...
  const testimonials = [
    {
      ...
      content:
        "Carmen has revolutionized our procurement process. We've reduced ordering time by 60% and eliminated stock-out situations completely.",
    },
    {
      name: "Michael Chen",
      ...
      content:
        "The multi-property support is outstanding. Managing inventory across our 5 hotel properties has never been easier. Real-time visibility is a game-changer.",
    },
    {
      name: "Emma Rodriguez",
      role: "F&B Director",
      ...
      content:
        "Tracking stock movements between kitchen, bar, and storage areas is seamless. The reporting features help us reduce waste by 40%.",
    },
  ];
        ...
        <div className="container mx-auto w-full max-w-5xl px-6">
          <div className="mb-12">
            ...
            <p className="text-muted-foreground my-4 text-balance text-lg">
              Discover how Carmen helps hotels optimize their inventory operations. Read
              testimonials from procurement managers, hotel operators, and F&B directors who trust
              our platform.
            </p>
          </div>
