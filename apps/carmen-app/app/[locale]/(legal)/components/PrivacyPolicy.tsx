    ...
    return (
        <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold mb-3">2.1 {t("privacy.infoCollect.personal.title")}</h3>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">2.2 {t("privacy.infoCollect.usage.title")}</h3>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">2.3 {t("privacy.infoCollect.business.title")}</h3>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">2.4 {t("privacy.infoCollect.technical.title")}</h3>
                <ul>
            ...
            <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">3.2 {t("privacy.howWeUse.improvement.title")}</h3>
                <ul>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">3.3 {t("privacy.howWeUse.security.title")}</h3>
                <ul>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">3.4 {t("privacy.howWeUse.communication.title")}</h3>
                <ul>
            ...
            <section className="mb-8">
                ...
                <ul>
                    <li>
                        <strong>{t("privacy.thirdParty.sentry.title")}:</strong> {t("privacy.thirdParty.sentry.description")}
                    </li>
                    <li>
                        <strong>{t("privacy.thirdParty.hosting.title")}:</strong> {t("privacy.thirdParty.hosting.description")}
                    </li>
                </ul>
            </section>
            ...
            <section className="mb-8">
                ...
                <ul>
                    <li>
                        <strong>{t("privacy.security.encryption.title")}:</strong> {t("privacy.security.encryption.description")}
                    </li>
                    <li>
                        <strong>{t("privacy.security.authentication.title")}:</strong> {t("privacy.security.authentication.description")}
                    </li>
                    <li>
                        <strong>{t("privacy.security.isolation.title")}:</strong> {t("privacy.security.isolation.description")}
                    </li>
                    <li>
                        <strong>{t("privacy.security.accessControl.title")}:</strong> {t("privacy.security.accessControl.description")}
                    </li>
                    <li>
                        <strong>{t("privacy.security.auditLog.title")}:</strong> {t("privacy.security.auditLog.description")}
                    </li>
                    <li>
                        <strong>{t("privacy.security.backups.title")}:</strong> {t("privacy.security.backups.description")}
                    </li>
                </ul>
            </section>
            ...
            <section className="mb-8">
                ...
                <ul>
                    ...
                    <li>
                        <strong>{t("privacy.rights.restrict.title")}:</strong> {t("privacy.rights.restrict.description")}
                    </li>
                    <li>
                        <strong>{t("privacy.rights.portability.title")}:</strong> {t("privacy.rights.portability.description")}
                    </li>
                    <li>
                        <strong>{t("privacy.rights.object.title")}:</strong> {t("privacy.rights.object.description")}
                    </li>
                    <li>
                        <strong>{t("privacy.rights.withdraw.title")}:</strong> {t("privacy.rights.withdraw.description")}
                    </li>
                </ul>
