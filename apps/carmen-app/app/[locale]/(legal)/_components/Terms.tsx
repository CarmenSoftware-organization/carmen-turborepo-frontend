    ...
    return (
        <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">3.3 {t("terms.account.termination.title")}</h3>
            ...
            <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">4.2 {t("terms.subscription.payment.title")}</h3>
                <ul>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">4.3 {t("terms.subscription.priceChanges.title")}</h3>
            ...
            <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold mb-3">6.1 {t("terms.intellectualProperty.our.title")}</h3>
                <p>{t("terms.intellectualProperty.our.description")}</p>

                <h3 className="text-xl font-semibold mb-3 mt-6">6.2 {t("terms.intellectualProperty.yourContent.title")}</h3>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">6.3 {t("terms.intellectualProperty.feedback.title")}</h3>
            ...
            <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">8.2 {t("terms.serviceLevel.maintenance.title")}</h3>
                <p>{t("terms.serviceLevel.maintenance.description")}</p>

                <h3 className="text-xl font-semibold mb-3 mt-6">8.3 {t("terms.serviceLevel.support.title")}</h3>
            ...
            <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">12.2 {t("terms.termination.byYou.title")}</h3>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">12.3 {t("terms.termination.byUs.title")}</h3>
            ...
            <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">14.2 {t("terms.governingLaw.dispute.title")}</h3>
            ...
            <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">15.2 {t("terms.general.severability.title")}</h3>
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">15.4 {t("terms.general.assignment.title")}</h3>
                <p>{t("terms.general.assignment.description")}</p>

                <h3 className="text-xl font-semibold mb-3 mt-6">15.5 {t("terms.general.forceMajeure.title")}</h3>
            ...
            <section className="mb-8">
                ...
                <div className="mt-4 p-4 bg-muted rounded-lg">
                    ...
                    <p>
                        {t("terms.contact.address")}: [Your Company Address]
                    </p>
                </div>
            </section>
