    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          ...
          <a
            target="_blank"
            href="http://dev.blueledgers.com:3997/organizations/sentry/issues/?project=3"
          >
            Issues Page
          </a>
        ...
        >
          ...
          >
            <span>Throw Sample Error (Frontend + Backend)</span>
          </button>
          ...
          <button
            ...
            onClick={() => {
              ...
              try {
                throw new SentryExampleFrontendError(
                  "This is a client-side only error for testing Sentry."
                );
              } catch (error) {
          ...
          >
            <span>Throw Client-Side Only Error</span>
          </button>
        </div>
