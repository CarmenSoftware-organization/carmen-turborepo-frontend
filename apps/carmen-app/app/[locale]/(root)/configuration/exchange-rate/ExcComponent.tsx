...
import ExcDialog from "./ExcDialog";
...
export default function ExcComponent() {
  ...
  const content = <ExcList excList={excData} onEdit={onEdit} />;
  ...
  return (
    <>
      <DataDisplayTemplate
        ...
        content={content}
      />
      <ExcDialog open={dialogOpen} onOpenChange={setDialogOpen} initialData={selectedExc} />
    </>
  );
}
