...
import { ColumnDef, getSortedRowModel, getPaginationRowModel, PaginationState, SortingState, useReactTable, getCoreRowModel, getFilteredRowModel } from "@tanstack/react-table";
    ...
    const columns = useMemo<ColumnDef<IUnitData>[]>(
        () => [
            ...
            },
            {
                ...
                cell: ({ row }) => {
                    return (
                        <span>{row.original.is_decimal ? 'Yes' : 'No'}</span>
                    );
                },
                size: 150,
                enableSorting: true,
