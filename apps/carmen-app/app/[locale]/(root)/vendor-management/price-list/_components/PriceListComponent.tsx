...
export default function PriceListComponent() {
  ...
  const actionButtons = (
    <div className="action-btn-container" data-id="price-list-list-action-buttons">
      <FormDialogPriceList open={addDialogOpen} onOpenChange={setAddDialogOpen} />
      <Button variant="outlinePrimary" size={"sm"} data-id="price-list-export-button">
        <FileDown className="h-4 w-4" />
        {tCommon("export")}
      </Button>
      <Button variant="outlinePrimary" size={"sm"} data-id="price-list-print-button">
