...
export default function PriceListComponent() {
    ...
    const filters = (
        <div className="filter-container" data-id="price-list-filters">
            <SearchInput
                defaultValue={search}
                onSearch={setSearch}
                placeholder={tCommon('search')}
                data-id="price-list-search-input"
            />
            <div className="flex items-center gap-2">
                <StatusSearchDropdown
                    ...
                    data-id="price-list-status-search-dropdown"
                />
                <SortComponent
                    fieldConfigs={sortFields}
                    sort={sort}
                    setSort={setSort}
                    data-id="price-list-sort-dropdown"
                />
                <Button size={'sm'}>
                    Add Filter
                </Button>
