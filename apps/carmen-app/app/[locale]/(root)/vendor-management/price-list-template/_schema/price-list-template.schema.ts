...
export const PriceTemplateResponseSchema = z.object({
  ...
  validity_period: z.number().int().positive(),
  create_date: z.string().datetime(),
  update_date: z.string().datetime(),
  vendor_instructions: z.string().optional(),
...
export const CreatePriceTemplateRequestSchema = z.object({
  ...
  validity_period: z.number().int().positive().max(365),
  vendor_instructions: z.string().max(2000).optional(),
...
export const UpdatePriceTemplateRequestSchema = z.object({
  ...
  description: z.string().max(1000).optional(),
  validity_period: z.number().int().positive().max(365).optional(),
  vendor_instructions: z.string().max(2000).optional(),
