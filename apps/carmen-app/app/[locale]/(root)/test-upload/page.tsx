    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Upload and manage your images with our easy-to-use interface. Supports multiple file
          uploads with drag and drop functionality.
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {uploadedFiles.map((file, index) => (
              ...
              >
                ...
                />
                <div className="p-3">
                  <p className="text-sm text-muted-foreground truncate">ID: {file.id}</p>
                  {file.description && (
                    <p className="text-sm text-foreground mt-1">{file.description}</p>
                  )}
                </div>
              </div>
            ))}
