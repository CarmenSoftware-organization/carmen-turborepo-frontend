...
export default function StockCardComponent() {
  ...
  const actionButtons = (
    <div className="flex flex-col md:flex-row gap-2" data-id="stock-card-action-buttons">
      <Button size={"sm"}>
      ...
      <Button variant="outline" size={"sm"} data-id="stock-card-list-print-button">
  ...
  const filters = (
    <div className="flex flex-col md:flex-row gap-4 justify-between" data-id="stock-card-list-filters">
      <SearchInput
        defaultValue={search}
        onSearch={setSearch}
