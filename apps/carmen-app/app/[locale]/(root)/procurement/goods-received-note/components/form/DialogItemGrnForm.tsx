...
const GrnItemFormSchema = z.object({
  ...
  received_qty: z
    .number()
    .nonnegative("Received quantity must be non-negative"),
  received_unit_id: z.string().optional(),
  is_foc: z.boolean().default(false),
  foc_qty: z
    .number()
    .nonnegative("FOC quantity must be non-negative")
    .default(0),
  ...
  base_qty: z
    .number()
    .nonnegative("Base quantity must be non-negative")
    .default(0),
  extra_cost: z
    .number()
    .nonnegative("Extra cost must be non-negative")
    .default(0),
  total_cost: z
    .number()
  ...
  discount_rate: z
    .number()
    .nonnegative("Discount rate must be non-negative")
    .default(0),
  discount_amount: z
    .number()
  ...
  exchange_rate: z
    .number()
    .nonnegative("Exchange rate must be non-negative")
    .default(1),
  info: z
    .object({
...
const mockOnOrder = [
  {
    ...
    remainingQty: 200,
    units: "pcs",
    locations: "Warehouse A, B",
  },
  {
    id: "2",
    poNumber: "PO-2023-002",
    vendor: "Green Valley Co",
    deliveryDate: "2023-08-20",
    remainingQty: 150,
    units: "pcs",
    locations: "Store Front",
  },
];
...
const convertFormValuesToDto = (
  ...
  return {
    ...
    tax_type_inventory_id:
      formValues.tax_type_inventory_id || formValues.order_unit_id,
        ...
        <DialogContent className="sm:max-w-[1000px]">
          ...
          <div className="bg-muted p-2 rounded-md">
            <div className="flex justify-between">
              ...
              <Badge
                variant="default"
                className="text-xs bg-emerald-200 text-emerald-800"
              >
                Accepted
              </Badge>
            </div>
            ...
            <p className="text-xs text-muted-foreground">
              Premium organic white quinoa grains
            </p>
          </div>
          <Table>
            <TableHeader>
