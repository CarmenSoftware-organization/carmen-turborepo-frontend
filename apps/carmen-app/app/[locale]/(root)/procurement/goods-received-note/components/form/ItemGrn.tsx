    ...
    const columns = useMemo<ColumnDef<GrnDetailItem>[]>(
        () => [
            ...
            },
            {
                ...
                header: ({ column }) => (
                    <DataGridColumnHeader column={column} title="Location" icon={<MapPin className="h-4 w-4" />} />
                ),
                cell: ({ row }) => (
            ...
            },
            {
                ...
                header: ({ column }) => (
                    <DataGridColumnHeader column={column} title="Product" icon={<Package className="h-4 w-4" />} />
                ),
                cell: ({ row }) => (
            ...
            },
            {
                ...
                header: ({ column }) => (
                    <div className="flex justify-end">
                        <DataGridColumnHeader column={column} title="Ordered" icon={<ShoppingCart className="h-4 w-4" />} />
                    </div>
                ),
                cell: ({ row }) => (
            ...
            },
            {
                ...
                header: ({ column }) => (
                    <div className="flex justify-end">
                        <DataGridColumnHeader column={column} title="Received" icon={<Package className="h-4 w-4" />} />
                    </div>
                ),
                cell: ({ row }) => (
                    <div className="text-right">
            ...
            },
            {
                ...
                header: ({ column }) => (
                    <div className="flex justify-end">
                        <DataGridColumnHeader column={column} title="Price" icon={<DollarSign className="h-4 w-4" />} />
                    </div>
                ),
                cell: ({ row }) => (
                    <div className="text-right font-mono text-sm">
                        {parseFloat(row.original.price).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                    </div>
                ),
                enableSorting: true,
                size: 100,
            ...
            },
            {
                ...
                cell: ({ row }) => (
                    <div className="text-right font-mono text-sm">
                        {row.original.discount_amount ? parseFloat(row.original.discount_amount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : '0.00'}
                    </div>
                ),
                enableSorting: true,
                size: 100,
            ...
            },
            {
                ...
                cell: ({ row }) => (
                    <div className="text-right">
                        <div className="font-mono text-sm">
                            {parseFloat(row.original.tax_amount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                        </div>
            ...
            },
            {
                ...
                header: ({ column }) => (
                    <div className="flex justify-end">
                        <DataGridColumnHeader column={column} title="Total" icon={<DollarSign className="h-4 w-4" />} />
                    </div>
                ),
                cell: ({ row }) => (
                    <div className="text-right font-mono text-sm font-medium">
                        {parseFloat(row.original.total_amount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                    </div>
                ),
                enableSorting: true,
                size: 120,
