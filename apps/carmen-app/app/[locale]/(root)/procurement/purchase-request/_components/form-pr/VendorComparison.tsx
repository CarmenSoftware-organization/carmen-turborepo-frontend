        ...
        columnHelper.display({
            ...
            cell: ({ row }) => (
                <div className="flex flex-col max-w-[200px]">
                    ...
                    <p className="truncate text-xs text-muted-foreground">{row.original.pricelist_description}</p>
                </div>
            ),
            size: 200,
        }),
                ...
                <Card className="p-2 space-y-2">
                    <div className="flex items-center justify-between gap-2">
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">Heavy-duty commercial stand mixer, 20 quart capacity</p>
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        <div className="text-right p-2 border border-border rounded-md">
                            ...
                            <p className="text-xs font-medium">{req_qty} {req_unit}</p>
                        </div>
                        <div className="text-right p-2 border border-border rounded-md">
                            <p className="text-xs text-muted-foreground">Approved</p>
                            <p className="text-xs font-medium">{apv_qty} {apv_unit}</p>
                        </div>
                    </div>
                </Card>
                <Card className="p-2 space-y-2">
