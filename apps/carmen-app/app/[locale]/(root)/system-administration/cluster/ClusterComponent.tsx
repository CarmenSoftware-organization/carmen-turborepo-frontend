    ...
    () => [
      {
        ...
        cell: ({ row }) => <div className="font-medium text-foreground">{row.original.code}</div>,
        size: 150,
        enableSorting: true,
      },
      {
        ...
        cell: ({ row }) => <div className="text-foreground">{row.original.name}</div>,
        size: 200,
        enableSorting: true,
      },
      {
  ...
  const EmptyState = () => (
    <div className="flex flex-col items-center justify-center py-12 space-y-4">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-muted-foreground">Get started by creating your first cluster</p>
      </div>
    </div>
  );
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Update the cluster information</DialogDescription>
          </DialogHeader>
          <Form {...editForm}>
            <div className="space-y-4">
              <FormField
