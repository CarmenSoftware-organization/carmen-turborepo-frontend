...
import { Stage, WorkflowCreateModel } from "@/dtos/workflows.dto";
                ...
                <div className="grid gap-2 mt-2">
                  <div className="flex items-center space-x-2">
                    <Form.FormField
                      ...
                      render={({ field }) => (
                        <FieldForm {...field} label="Requester" disabled={!isEditing} />
                      )}
                    />
                  </div>
                  {selectedStage.available_actions.approve.is_active && (
                    <div className="flex items-center space-x-2">
                      <Form.FormField
                        ...
                        render={({ field }) => (
                          <FieldForm {...field} label="Next Stage Approver" disabled={!isEditing} />
                        )}
                      />
                    </div>
                  )}
                ...
                <div className="grid gap-2 mt-2">
                  <div className="flex items-center space-x-2">
                    <Form.FormField
                      ...
                      render={({ field }) => (
                        <FieldForm {...field} label="Requestor" disabled={!isEditing} />
                      )}
                    />
                  </div>
                  <div className="flex items-center space-x-2">
                    <Form.FormField
                      ...
                      render={({ field }) => (
                        <FieldForm {...field} label="Current Approver" disabled={!isEditing} />
                      )}
                    />
                  </div>
                  {selectedStage.available_actions.approve.is_active && (
            ...
            <div>
              ...
              <div className="grid gap-2 mt-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="sla-current-approver" className="cursor-pointer">
                    Current Approver
                  </Label>
                </div>
              </div>
