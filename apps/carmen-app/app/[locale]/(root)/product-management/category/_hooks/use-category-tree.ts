...
export const useCategoryTree = ({
  ...
  const updateNodeInTree = useCallback(
    (nodes: CategoryNode[], updatedNode: CategoryNode): CategoryNode[] => {
  ...
  const addNodeToTree = useCallback(
    (nodes: CategoryNode[], newNode: CategoryNode, parentId?: string): CategoryNode[] => {
      if (!parentId) {
  ...
  const deleteNodeFromTree = useCallback(
    (nodes: CategoryNode[], nodeId: string): CategoryNode[] => {
