            ...
            <ScrollArea className="h-[calc(100vh-10rem)]">
                <div className="flex flex-col md:flex-row gap-4 mb-4">
                    ...
                    <div className="md:w-1/2 space-y-2 text-xs">
                        ...
                        <div className="fxr-c gap-4 text-gray-600">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Card>
                        <CardHeader>
                            <h2 className="text-lg font-semibold fxr-c gap-2">
                        ...
                        <CardContent>
                            <ol className="space-y-2 text-xs">
                                {recipe.instructions.map((instruction, index) => (
                                    <li key={`instruction-${instruction}`} className="fxr-c gap-4">
                                        <span className="flex-shrink-0 w-8 h-8 bg-primary text-primary-foreground rounded-full fxr-c justify-center font-semibold">
                                            {index + 1}
                                        </span>
                        ...
                        <CardContent>
                            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                                {recipe.ingredients.map((ingredient) => (
                                    <li key={`ingredient-${ingredient}`} className="fxr-c gap-2">
