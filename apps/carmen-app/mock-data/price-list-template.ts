...
export const mockPriceListTemplates: PriceListTemplateListDto[] = [
  {
    ...
    vendor_instruction: "Please provide pricing for Q1 2025. Include all applicable taxes.",
    valid_period: 90,
  ...
  },
  {
    ...
    vendor_instruction: "Ensure all products meet Halal certification requirements.",
    valid_period: 60,
  ...
  },
  {
    ...
    vendor_instruction: "Standard monthly pricing update.",
    valid_period: 30,
  ...
  },
  {
    ...
    vendor_instruction: "Urgent: Prices needed by Friday EOD.",
    valid_period: 7,
  ...
  },
  {
    ...
    vendor_instruction: "Annual contract renewal. Please review terms attached.",
    valid_period: 365,
    create_date: new Date("2024-11-01"),
  ...
  },
  {
    ...
    vendor_instruction: "Focus on seasonal availability.",
    valid_period: 120,
