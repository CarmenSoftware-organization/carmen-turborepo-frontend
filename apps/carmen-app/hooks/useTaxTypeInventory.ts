...
export const useTaxTypeInventoryQuery = (token: string, buCode: string, params?: ParamsGetDto) => {
  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: async () => {
      ...
      return await getAllApiRequest(API_URL, token, "Error fetching credit note", params ?? {});
    },
